...
def personalInformation(urls):
    for url in urls:
        ...
        business = source.find('span',class_='business item')['title'] if source.find('span',class_='business item') !=None else '未知'
        locations= source.find('span',class_='location item')['title'] if source.find('span',class_='location item') !=None else '未知'
        companys = source.find('span',class_='employment item')['title'] if source.find('span',class_='employment item') !=None else '未知'
        posts    = source.find('span',class_='position item')['title'] if source.find('span',class_='position item') !=None else '未知'
        schools  = source.find('span',class_='education item')['title'] if source.find('span',class_='education item') !=None else '未知'
        professionals=source.find('span',class_='education-extra item')['title'] if source.find('span',class_='education-extra item') !=None else '未知'
        mylock.acquire()
